...
class MusiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post musicians_url, params: { musician: { bio: @musician.bio, image: @musician.image, instrument: @musician.instrument, name: @musician.name } }
    end
  ...
  test "should update musician" do
    patch musician_url(@musician), params: { musician: { bio: @musician.bio, image: @musician.image, instrument: @musician.instrument, name: @musician.name } }
